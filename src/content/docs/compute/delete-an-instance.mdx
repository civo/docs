...
Instances on Civo will remain in your account until you delete them. Instances that are in your account, even if switched off, [remain billable](/account/billing) and count towards your [account quota](/account/quota). If you no longer need an instance, you can delete it in the following ways.
