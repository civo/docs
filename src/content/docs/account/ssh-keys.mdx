...
<Tabs groupId="add-sshkey">
  <TabItem value="dashboard" label="Dashboard">
    ...
    You can now [launch virtual machine instances](../compute/create-an-instance) and automatically associate your created key with them, allowing you to log in without a password.
  </TabItem>
  ...
  <TabItem value="terraform" label="Terraform">
    ...
    Once you have configured the [Civo Terraform provider](../overview/terraform), you can define a an SSH key in Terraform.
