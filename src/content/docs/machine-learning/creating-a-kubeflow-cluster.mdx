...
---
:::note
Civo machine learning clusters are [billed hourly](/account/billing/) and count towards your [account quota](/account/quota/).
:::
...
You can create a new firewall along with creating this Kubeflow cluster, or choose from an existing one if present in the network. [Read more about firewalls on Civo](/networking/firewalls/).

### Network

The [private network](/networking/private-networks/) for the Kubeflow Cluster to be situated in. You can choose from the default network for your account in the current region, or if you have created networks prior to creating this Kubeflow Cluster, you can choose one of them.
